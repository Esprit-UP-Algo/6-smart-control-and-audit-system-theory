    ...
    ui(new Ui::MainWindowmission)
{
    ...
    ui->lineEdit_DATE_2->setValidator(new QRegExpValidator(QRegExp("\\d{2}/\\d{2}/\\d{4}"),this));
...
void MainWindowmission::on_pushButton_ajouter_2_clicked()
{
 qDebug();

 int code_mission=ui->lineEdit_CODE_3->text().toInt();

    QString date_mission=ui->lineEdit_DATE_2->text();
    QString statut_mission=ui->lineEdit_STATUT_2->text();
...
void MainWindowmission::on_pushButton_supp_2_clicked()
{
    int code_mission=ui->lineEdit_Supp_2->text().toInt();
...
void MainWindowmission::on_affichem_2_clicked()
{

    ui->tableView_2->setModel(m.afficher());
}

void MainWindowmission::on_pushButton_modifier_2_clicked()
{
    qDebug();
    int code_mission=ui->lineEdit_CODE_3->text().toInt();
    ...
    if (test){ ui->tableView_2->setModel(m.afficher());
...
void MainWindowmission::on_pb_recher_2_clicked()
...
void MainWindowmission::on_pb_trier_2_clicked()
{
    QSqlQueryModel *sortedModel = m.trier(2);
    ui->tableView_2->setModel(sortedModel);
}
void MainWindowmission::on_pb_stat_2_clicked()
{
    QSqlQuery query;
...
void MainWindowmission::on_pb_pdf_2_clicked()
{  QString fileName = QFileDialog::getSaveFileName(this, "Exporter en PDF", "", "Fichiers PDF (*.pdf)");
    ...
    QSqlQueryModel *model = static_cast<QSqlQueryModel*>(ui->tableView_2->model());
...
#include <QVBoxLayout>
#include <QWidget>
void MainWindowmission::on_png_2_clicked()
{        int afficheur_code = ui->lineEdit_CODE_3->text().toInt();
...
void MainWindowmission::on_tableau_2_clicked()
{

  ui->tableView_2->setModel(m.tableau());
