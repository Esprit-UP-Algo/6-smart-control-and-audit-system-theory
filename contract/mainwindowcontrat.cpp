...
void MainWindowContrat::readData()
{
    ...
    if (index != -1) {
        ...
        ui->contrat_lineEdit_code->setText(QString::number(id1));
        ui->contrat_pass->setText(search);

    }
    else if(ha != -1)
    {
        ui->lineEdit_codemod->setText(QString::number(id2));
        ui->contrat_pass->setText(second);
    }
